...
| Well-log tests | `tests/` | 122 project tests expected after the DOE model-run tracker update | Expand with workbook-derived unit, label, and alignment cases |
