...
| 2026-07-06 | Added V15 after-notebook review cell | Added `code_transfer_block/v15_after_notebook_copy_this_cell.py` so DOE/VS Code can paste one notebook cell after V15 finishes to build the presentation-review packet and open Outlook without manually opening a terminal. |
