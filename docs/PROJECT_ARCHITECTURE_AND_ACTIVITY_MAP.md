...
| Source library | Index recovered; 2026-06-13 stability source bundle documented, uploaded locally in OpenScienceLab, and connected to a Structural Explorer source panel | In progress | Convert source layers into stability-screen features and digitize/georeference OM-222 if no ready GIS derivative is found |
...
| W2 | Organize source intake | In progress | The public stability source bundle is documented and uploaded locally under `data/source_library/`; continue classifying recovered sources and keep downloaded bundles out of Git | W1 | Every recovered file has a location and classification |
