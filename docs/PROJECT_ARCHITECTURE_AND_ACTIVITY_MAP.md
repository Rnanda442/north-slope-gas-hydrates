...
|---|---|---|---|
| Public atlas | `dashboard/app.py` | Four-page Processing-style visual redesign implemented with legacy route aliases; Explore North Slope exposes the guarded stability screen, and Analyze Hydrates now includes a real public ML Readiness tab plus the synthetic ML visual architecture section | Polish visuals and keep public/synthetic data boundary verified during deployment |
