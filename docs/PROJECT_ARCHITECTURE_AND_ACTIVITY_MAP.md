...
| Well-log tests | `tests/` | `122 passed, 2 skipped` verified after the 2026-06-18 project-revision-base merge and unified website map update | Expand with workbook-derived unit, label, and alignment cases |
