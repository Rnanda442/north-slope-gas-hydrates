...
| W10 | Word and PowerPoint deliverables | In progress | Review the 2026-06-15 diagram-first workflow deck and Word companion beside the 2026-06-13 native Google Docs/Slides imports, then decide what becomes the next official Word/PPT refresh | W3, W5, W7 | Both deliverables use the verified workflow, figures, terminology, parameter tiers, screening-envelope language, guarded model options, validation plan, and no unsupported results claims |
...
`docs/FULL_PROJECT_ML_WORKFLOW_DIAGRAM.md` and the local
`docs/project_blueprints/FULL_WORKFLOW_ML_DIAGRAM_9_SLIDE_North_Slope_Gas_Hydrate_Slides_2026-06-15.pptx`
diagram-first draft for the next slide-review pass before any Drive
replacement. Treat the earlier
