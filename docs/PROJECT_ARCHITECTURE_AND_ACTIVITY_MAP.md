...
| Well-log tests | `tests/` | `119 passed, 2 skipped` verified after the 2026-06-19 editable visual-match deck rebuild | Expand with workbook-derived unit, label, and alignment cases |
