...
FULL_WORKFLOW_ML_NETWORK = FULL_WORKFLOW_ASSET_DIR / "ml_pipeline_network_detail_v4.png"
...
def render_full_workflow_map_panel() -> None:
    ...
    st.caption(
        "The canvas below is the Processing-style interactive overview; the static exports/downloads are detailed V4 diagrams generated by the reproducible Python builder."
    )
