...
FULL_WORKFLOW_DRIVE_SLIDES_URL = "https://docs.google.com/presentation/d/1w9eqANgOc89c1wCUC0xi9eZoBup-3JNllSUI923skgA"
FULL_WORKFLOW_DRIVE_DOC_URL = "https://docs.google.com/document/d/1dWBNYmwGerBV8steCo0v37PbhpIAZzqNQ-Psl78Ypa8"
...
def render_full_workflow_map_panel() -> None:
    ...
    st.caption(
        "The canvas below is the Processing-style interactive overview; the static exports/downloads are detailed V5.2 diagrams generated by the reproducible Python builder."
    )
    ...
    st.info(
        "Use the V5.2 deck and companion as the mentor-facing roadmap: stability is a context/admissibility branch, "
...
def render_schema_coverage_architecture() -> None:
    ...
    latest_roles = [
        {
            "Artifact": "V5.2 slide deck",
            "Role": "Mentor-readable presentation with the project cover, hydrate intro, slide-scale workflow, expanded architecture map, stability context, variable-fingerprint decisions, ML runtime detail, model decision boxes, and open mentor decisions.",
        ...
        {
            "Artifact": "V5.2 Word companion",
            "Role": "Research/source-backed explanation of the same workflow, including Current ML Architecture Decisions, Variable Fingerprint And Intake Validator, and Research Source Anchors.",
    ...
    if FULL_WORKFLOW_DRIVE_SLIDES_URL or FULL_WORKFLOW_DRIVE_DOC_URL:
        ...
        if FULL_WORKFLOW_DRIVE_SLIDES_URL:
            link_parts.append(f"[Open V5.2 Google Slides]({FULL_WORKFLOW_DRIVE_SLIDES_URL})")
        if FULL_WORKFLOW_DRIVE_DOC_URL:
            link_parts.append(f"[Open V5.2 Google Doc]({FULL_WORKFLOW_DRIVE_DOC_URL})")
