...
def render_full_workflow_map_panel() -> None:
    ...
    st.caption(
        "The canvas below is the Processing-style interactive overview; the static exports/downloads are detailed V5 diagrams generated by the reproducible Python builder."
    )
