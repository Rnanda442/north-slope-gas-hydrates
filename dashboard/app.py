...
def render_full_workflow_map_panel() -> None:
    ...
    st.caption(
        "The canvas below is the Processing-style interactive overview; the static export/download is the detailed V3 diagram generated by the reproducible Python builder."
    )
