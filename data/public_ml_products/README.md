...
Hydrate-01, HYDRATE 02, and associated public source/test-site anchors. It
does not contain workbook rows, log/core rows, pressure-core values, model
outputs, or proof that every public source-case anchor is an active ML workbook
sheet.
